<template>
    <div class="shop-header">
        ...
        <div class="shop-content">
          ...
          <span class="content-tag">
            <span class="mini-tag">品牌</span>
                    ...
                    <i class="content-icon" @click="showBrief=true"></i>
                </h2>
        ...
        <div class="shop-header-discounts" v-if="info.supports">
            ...
            <div class="discounts-right" @click="showSheet=true">
        ...
        <transition name="fade">
            ...
            <div class="activity-sheet-content">
                <h2 class="activity-sheet-title">
                    优惠活动</h2>
                <ul class="list" v-show="info.supports">
                    <li class="activity-item" v-for="(support,i) in info.supports" :key="i" :class="classArr[support.type]">
                        <span class="content-tag">
                ...
                <div class="activity-sheet-close" @click="showSheet=false">
